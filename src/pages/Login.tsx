    ...
    <div className="min-h-screen bg-primary-dark flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-card rounded-2xl shadow-2xl p-8 animate-fadeInUp">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary mt-2">Sign in to your D-EDI account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center">
              <input type="checkbox" className="rounded border-gray-300 text-accent shadow-sm focus:ring-accent" />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-accent hover:bg-accent-dark text-white py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 disabled:opacity-70 disabled:scale-100"
          >
          ...
          <button
            ...
            className="w-full mt-2 bg-white border border-gray-300 text-text-secondary py-3 rounded-lg font-semibold flex items-center justify-center hover:bg-gray-50 transition-all duration-200"
          >
